...
const Task = ({ item, text, deleteTask, updateTask, edit, setEdit, visible, setVisible, isChecked, setCheckedTask, withEmpty }) => {
    return <>{edit
        ? < li className="task">
            {/* InputEdit component */}
            <InputEdit
        ...
        : <li className="task"
            ...
            <div className="task__info info-task">
                <label className="info-task__checkbox">
                    ...
                    <input type="checkbox" checked={isChecked || ""} onChange={() => setCheckedTask()} />
                    <span></span>
                </label>
                {isChecked
            ...
            {visible ? <div className="task__icons">
